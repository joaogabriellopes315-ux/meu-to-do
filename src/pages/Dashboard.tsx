...
const Dashboard = () => {
  ...
  const updateDeleteConfirmation = (id: string) => {
    setShowDeleteConfirmation(id);
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600"> {user?.email ?? "Organize suas tarefas com simplicidade."} </p>
          </div>
        ...
        <section className="grid gap-4 sm:grid-cols-3">
          <Card className="border-slate-200 bg-white shadow-sm">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-slate-500"> Total de tarefas </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-slate-200 bg-white shadow-sm">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-slate-500"> Edição ativa </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <section className="grid gap-6 lg:grid-cols-[360px_1fr]">
          <div className="space-y-4">
            ...
            <Card className="border-slate-200 bg-white shadow-sm">
              <CardHeader>
                ...
                <CardDescription> Mantenha suas tarefas objetivas e revise sua lista todos os dias. </CardDescription>
              </CardHeader>
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-xl font-semibold text-slate-950"> Suas tarefas </h2>
                <p className="text-sm text-slate-500"> Crie, edite e remova tarefas em tempo real. </p>
              </div>
            ...
            <TaskList               tasks={tasks} 
              ...
              updateEditConfirmation={updateEditConfirmation} 
